...
public struct ChatUserProperties: Codable {
    ...
    public init(type: ModelType, _id: Int64, callStatus: CallStatus? = nil, displayName: String, displayPictureUrl: String, isGuest: Bool, name: String, presence: ChatUserPresenceProperties, properties: AnyCodable) {
        self.type = type
        self._id = _id
