//
// FileSystemMessageProperties.swift
//
...
public struct FileSystemMessageProperties: Codable {
    ...
    public init(type: ModelType, _id: Int64, channelId: Int64, createdTime: Date, groupTag: String? = nil, lastEditedTime: Date? = nil, nestedLevel: Int, properties: AnyCodable, reactions: [MessageReactionsSummaryProperties]? = nil, repliesCount: Int64? = nil, file: FileProperties) {
        self.type = type
        self._id = _id
