//
// ChatUserMessageMentionProperties.swift
//
...
public struct ChatUserMessageMentionProperties: Codable {
    ...
    public init(type: ModelType, endPosition: Int, startPosition: Int, tag: String, user: ChatUserProperties) {
        self.type = type
