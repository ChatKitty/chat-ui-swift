//
// FileSystemMessageResource.swift
//
...
public struct FileSystemMessageResource: Codable {
    ...
    public init(type: ModelType, _id: Int64, channelId: Int64, createdTime: Date, file: FileProperties, groupTag: String? = nil, lastEditedTime: Date? = nil, nestedLevel: Int, properties: AnyCodable, reactions: [MessageReactionsSummaryProperties]? = nil, repliesCount: Int64? = nil, links: Links? = nil) {
        self.type = type
        self._id = _id
