...
public struct DirectChannelResource: Codable {
    ...
    public init(type: ModelType, _id: Int64, createdTime: Date, creator: ChatUserProperties? = nil, lastReceivedMessage: MessageProperties? = nil, members: [ChatUserProperties], properties: AnyCodable, links: Links? = nil) {
        self.type = type
        self._id = _id
